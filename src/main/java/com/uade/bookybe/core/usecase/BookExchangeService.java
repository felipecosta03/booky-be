...
public interface BookExchangeService {
   ...
   */
  Optional<BookExchange> createExchange(String requesterId, String ownerId, List<String> ownerBookIds, List<String> requesterBookIds);
   ...
   */
  Optional<BookExchange> updateExchangeStatus(String exchangeId, String userId, ExchangeStatus status);
  
  /**
   * Creates a counter offer for an existing exchange
   */
  Optional<BookExchange> createCounterOffer(String exchangeId, String userId, List<String> ownerBookIds, List<String> requesterBookIds);
