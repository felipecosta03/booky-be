...
(1, '9780060935467', 'To Kill a Mockingbird', 'Harper Lee', 'A classic of modern American literature', 376, 'Harper Perennial', NULL),
(2, '9780747532699', 'Harry Potter and the Philosopher''s Stone', 'J.K. Rowling', 'The first book in the Harry Potter series', 223, 'Bloomsbury', NULL),
(3, '9780451524935', '1984', 'George Orwell', 'A dystopian social science fiction novel', 328, 'Signet Classics', NULL),
(4, '9780060850524', 'Brave New World', 'Aldous Huxley', 'A dystopian novel about a futuristic society', 268, 'Harper Perennial', NULL),
(5, '9780142000281', 'Of Mice and Men', 'John Steinbeck', 'A novella about two displaced migrant ranch workers', 112, 'Penguin Classics', NULL);
...
('club-001', NOW() - INTERVAL '1 month', 'Club dedicado a la lectura y análisis profundo de "To Kill a Mockingbird". Exploramos temas de justicia, racismo y crecimiento moral.', NOW() - INTERVAL '1 week', 'Club Mockingbird', 1, 'comm-001', 'user-001'),

('club-002', NOW() - INTERVAL '3 weeks', 'Redescubriendo la magia de Harry Potter desde una perspectiva adulta. Analizamos simbolismos, referencias y el mundo mágico de Rowling.', NOW() - INTERVAL '3 days', 'Magia Adulta', 2, 'comm-004', 'user-004'),

('club-003', NOW() - INTERVAL '2 weeks', 'Distopía orwelliana en tiempos modernos. ¿Qué tan cerca estamos del mundo de Winston Smith? Debate y reflexión crítica.', NOW() - INTERVAL '5 days', 'Hermano Mayor', 3, 'comm-003', 'user-003'),

('club-004', NOW() - INTERVAL '1 week', 'Huxley vs Orwell: dos visiones del futuro. ¿Control por placer o por miedo? Comparamos ambas distopías.', NOW() - INTERVAL '2 days', 'Mundo Feliz', 4, 'comm-007', 'user-007'),

('club-005', NOW() - INTERVAL '5 days', 'La amistad y los sueños rotos en la América de la Depresión. Steinbeck y su retrato crudo de la humanidad.', NOW() - INTERVAL '1 day', 'Ratones y Hombres', 5, 'comm-005', 'user-005');
...
(1, 'Fiction'), (1, 'Classic Literature'), (1, 'Social Issues'),
(2, 'Fantasy'), (2, 'Young Adult'), (2, 'Adventure'),
(3, 'Science Fiction'), (3, 'Dystopian'), (3, 'Political Fiction'),
(4, 'Science Fiction'), (4, 'Dystopian'), (4, 'Philosophy'),
(5, 'Fiction'), (5, 'Classic Literature'), (5, 'American Literature');
