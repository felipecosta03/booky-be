...
public class PostServiceImpl implements PostService {
  ...
  @Override
  public Optional<Post> createPost(String userId, String body, String communityId, MultipartFile image) {
  ...
  public List<Post> getPostsByCommunityId(String communityId) {
    ...
    return postRepository.findByCommunityIdOrderByDateCreatedDesc(communityId)
        .stream()
        .map(PostEntityMapper.INSTANCE::toModel)
        .collect(Collectors.toList());
  }
  ...
  public List<Post> getGeneralPosts() {
    ...
    return postRepository.findGeneralPostsOrderByDateCreatedDesc()
        .stream()
        .map(PostEntityMapper.INSTANCE::toModel)
        .collect(Collectors.toList());
  }
  ...
  public List<Post> getAllPosts() {
    ...
    return postRepository.findAllWithUserOrderByDateCreatedDesc()
        .stream()
        .map(PostEntityMapper.INSTANCE::toModel)
        .collect(Collectors.toList());
  }
  ...
  public List<Post> getUserFeed(String userId) {
    ...
    return postRepository.findPostsFromFollowedUsers(userId)
        .stream()
        .map(PostEntityMapper.INSTANCE::toModel)
        .collect(Collectors.toList());
  }
